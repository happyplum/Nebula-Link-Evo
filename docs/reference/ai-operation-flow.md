...
完整需求见 `ai-e2e/docs/requirements-baseline.md`；功能脚本和场景编排分别见 `ai-e2e/docs/functional-script-contract.md`、`ai-e2e/docs/scenario-orchestration-contract.md`。
