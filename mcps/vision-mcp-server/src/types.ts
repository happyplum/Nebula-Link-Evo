...
/** Dependencies injected into all MCP tools */
export interface ToolDeps {
  playwrightClient: import('./playwright-client.js').PlaywrightClient;
  visionAnalyzer: import('./vision-analyzer.js').VisionAnalyzer;
  cache: SnapshotCache;
}
