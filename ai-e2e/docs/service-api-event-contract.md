...
- 清理遵循第 2.3 节保留规则；proxy 可见的非终态 operation、未知结果和有效 upstream artifact hold 不得提前删除。长期 evidence manifest 保存提升后的 operation 摘要、哈希和 artifact，不以永久保留 proxy 热账本作为完整性前提。
