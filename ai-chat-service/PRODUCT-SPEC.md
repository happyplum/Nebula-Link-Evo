...
| `/api/v1/chat/sessions/:sessionId/stream` | GET (SSE) | shipped | Chat SSE（先发 `session.snapshot` 再续 live）                                               | plugins/routes/api/chat/stream、chat-session-controller                                                                              |
| `/api/v1/chat/*`                          | POST/GET  | shipped | 消息、任务控制、连通性与运行时状态                                                          | plugins/routes/api/chat                                                                                                              |
